...
var require_applicator2 = __commonJS({
  "../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/refs/json-schema-2020-12/meta/applicator.json"(exports2, module2) {
    module2.exports = {
      $schema: "https://json-schema.org/draft/2020-12/schema",
...
var require_unevaluated2 = __commonJS({
  "../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/refs/json-schema-2020-12/meta/unevaluated.json"(exports2, module2) {
    module2.exports = {
      $schema: "https://json-schema.org/draft/2020-12/schema",
...
var require_content = __commonJS({
  "../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/refs/json-schema-2020-12/meta/content.json"(exports2, module2) {
    module2.exports = {
      $schema: "https://json-schema.org/draft/2020-12/schema",
...
var require_format_annotation = __commonJS({
  "../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/refs/json-schema-2020-12/meta/format-annotation.json"(exports2, module2) {
    module2.exports = {
      $schema: "https://json-schema.org/draft/2020-12/schema",
...
var require_meta_data = __commonJS({
  "../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/refs/json-schema-2020-12/meta/meta-data.json"(exports2, module2) {
    module2.exports = {
      $schema: "https://json-schema.org/draft/2020-12/schema",
...
var require_json_schema_2020_12 = __commonJS({
  "../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/refs/json-schema-2020-12/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
var require__ = __commonJS({
  "../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/2020.js"(exports2, module2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
function createProvenanceClient(options = {}) {
...
// ../config-schema/dist/schema.json
var schema_default = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
  $id: "https://schemas.provenance.dev/config/v1/schema.json",
  title: "Provenance configuration v1",
  description: "Authoritative schema for provenance.yml. All durations are integer seconds, memory and disk quantities are integer MiB, and CPU quantities are decimal cores.",
  type: "object",
  additionalProperties: false,
  required: [
    "apiVersion",
  ...
  $defs: {
    ...
    minecraftVersion: {
      type: "string",
      pattern: "^(?:1\\.(?:[1-9]|[1-9][0-9])(?:\\.(?:0|[1-9][0-9]*))?|26\\.[1-9][0-9]*(?:\\.(?:0|[1-9][0-9]*))?)$"
    },
    sha256: {
      type: "string",
      pattern: "^[0-9a-f]{64}$"
    ...
    hostname: {
      ...
      minLength: 1,
      maxLength: 253,
      pattern: "^(?!localhost$)(?![0-9]+(?:\\.[0-9]+){3}$)(?:[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?)(?:\\.(?:[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?))+$"
    },
    port: {
      type: "integer",
      minimum: 1,
    ...
    paper: {
      type: "object",
      additionalProperties: false,
      required: ["matrix", "recommendations", "gatePolicy"],
      properties: {
        matrix: {
          type: "array",
          minItems: 1,
          ...
          uniqueItems: true,
          items: {
            $ref: "#/$defs/paperEnvironment"
          }
        },
        recommendations: {
          type: "object",
          additionalProperties: false,
          required: ["enabled", "apiFloor", "newVersions"],
          properties: {
            enabled: {
              type: "boolean"
            },
      ...
      properties: {
        ...
        console: {
          ...
          items: {
            type: "object",
            additionalProperties: false,
            required: ["id", "command", "timeoutSeconds", "assertions"],
            properties: {
              id: {
                $ref: "#/$defs/identifier"
              },
    ...
    release: {
      ...
      properties: {
        mode: {
          enum: ["test-only", "manual", "automatic"]
        },
        targets: {
          type: "array",
          maxItems: 16,
...
function hashConfiguration(value) {
  return (0, import_node_crypto.createHash)("sha256").update(normalizeConfiguration(value)).digest("hex");
}
...
var numeric = (v) => typeof v === "string" && /^[1-9][0-9]{0,19}$/.test(v);
var sha = (v) => typeof v === "string" && /^(?:[a-f0-9]{40}|[a-f0-9]{64})$/.test(v);
...
function https(value, originOnly = false) {
  ...
  if (u.protocol !== "https:" || u.username || u.password || u.hash || originOnly && (u.pathname !== "/" || u.search))
    fail("invalid_configuration");
  return u;
}
function timestamp(v) {
  if (typeof v !== "string" || !/^\d{4}-\d\d-\d\dT/.test(v) || !Number.isFinite(Date.parse(v)))
    fail("invalid_response");
  return Date.parse(v);
}
function exactKeys(v, required, optional = []) {
  if (!object(v) || required.some((k) => !Object.hasOwn(v, k)) || Object.keys(v).some((k) => !required.includes(k) && !optional.includes(k)))
    fail("invalid_response");
}
async function stableFile(path, limit) {
  finite(limit, 2147483647);
  let handle;
  try {
    const link = await (0, import_promises.lstat)(path, { bigint: true });
    if (!link.isFile() || link.isSymbolicLink()) fail("invalid_file");
    handle = await (0, import_promises.open)(path, import_node_fs.constants.O_RDONLY | import_node_fs.constants.O_NOFOLLOW);
    const before = await handle.stat({ bigint: true });
    if (!before.isFile() || before.size < 1n || before.size > BigInt(limit) || before.ino !== link.ino || before.dev !== link.dev)
      fail("invalid_file");
    ...
    const check = async () => {
      ...
      const current = await (0, import_promises.lstat)(path, { bigint: true });
      for (const key of ["dev", "ino", "size", "mtimeNs", "ctimeNs"]) {
        if (after[key] !== before[key] || current[key] !== before[key])
          fail("file_changed");
      }
...
function strictJSON(bytes) {
  try {
    ...
    const string = () => {
      const start = pos;
      if (text[pos++] !== '"') fail("invalid_response");
      for (; ; ) {
        if (pos >= text.length) fail("invalid_response");
        const char = text[pos++];
        if (char === "\\") {
          pos++;
          continue;
      ...
      const value2 = JSON.parse(text.slice(start, pos));
      if (!value2.isWellFormed()) fail("invalid_response");
      return value2;
    };
    const value = (depth) => {
      ...
      pos += match[0].length;
      if (!/^(true|false|null)$/.test(match[0]) && !Number.isFinite(Number(match[0])))
        fail("invalid_response");
    };
    value(0);
    ws();
...
var eventKinds = /* @__PURE__ */ new Set([
  "created",
  "testing_started",
  "test_completed",
  "approval_requested",
...
var descriptions = {
  submitted: [
    "pending",
    "Submitted; verification/publication not yet established"
  ],
  waiting: ["pending", "Waiting for an authoritative candidate outcome"],
  approval_required: [
    "pending",
    "Human approval required; publication not established"
  ],
...
var reportingState = (outcome) => descriptions[outcome] || descriptions.incomplete;
function validateInputs(c) {
  c.origin = https(c.origin, true).origin;
  if (!uuid(c.project) || !sha(c.commit) || typeof c.ref !== "string" || !c.ref.startsWith("refs/") || c.ref.length > 512 || /[\r\n\x00]/.test(c.ref) || typeof c.audience !== "string" || !c.audience || c.audience.length > 2048 || typeof c.repository !== "string" || !/^[A-Za-z0-9_.-]+\/[A-Za-z0-9_.-]+$/.test(c.repository) || !numeric(c.repositoryId) || !numeric(c.ownerId) || typeof c.version !== "string" || !c.version || c.version.length > 128 || typeof c.changelog !== "string" || c.changelog.length > 65536 || !["none", "status"].includes(c.report) || typeof c.wait !== "boolean")
    fail("invalid_configuration");
  finite(c.maxArtifactBytes, 2147483647);
  finite(c.requestMs, 12e4);
  finite(c.totalMs, 36e5);
  finite(c.pollMs, 6e4);
  finite(c.attempts, 5);
  finite(c.maxPages, 100);
  finite(c.responseBytes, 1048576);
  if (c.requestMs > c.totalMs || c.report === "status" && (typeof c.repositoryToken !== "string" || !c.repositoryToken))
    fail("invalid_configuration");
  return c;
}
async function runAction(input2, runtime) {
  ...
  const mask2 = runtime.mask || (() => {
  });
  const fetcher = runtime.fetch || fetch;
  let lastTime = started;
  const now = () => {
    const value = Date.now();
    if (value < lastTime) fail("clock_regressed");
    lastTime = value;
    return value;
  };
  ...
  const request = async (url, options = {}, credential = false) => {
    ...
    const abort2 = AbortSignal.any([
      signal,
      AbortSignal.timeout(Math.max(1, end - now()))
    ]);
    try {
  ...
  const json = async (r) => {
    if (!(r.headers.get("content-type") || "").toLowerCase().includes("application/json"))
      fail("invalid_response");
    try {
      return strictJSON(await r.arrayBuffer());
    } catch {
      fail("invalid_response");
    }
  };
  const report = async (state) => {
    ...
    const r = await request(
      `${runtime.githubOrigin || "https://api.github.com"}/repos/${config.repository}/statuses/${config.commit}`,
      {
        method: "POST",
        headers: {
          Authorization: `Bearer ${config.repositoryToken}`,
    ...
    if (!object(body) || body.state !== value || body.context !== "provenance/action")
      fail("reporting_failed");
  };
  try {
    config = validateInputs({ ...input2 });
    operationDeadline = started + config.totalMs;
    if (config.repositoryToken) mask2(config.repositoryToken);
    jar = await stableFile(config.artifactPath, config.maxArtifactBytes);
    source = await stableFile(config.configPath, 1048576);
    const rawYaml = new TextDecoder("utf-8", { fatal: true }).decode(
      source.bytes
    );
    let parsed;
    try {
      parsed = runtime.parseConfiguration(rawYaml);
    } catch {
      fail("invalid_configuration");
    }
    ...
    if (!runtime.testEndpoints && !oidcURL.hostname.endsWith(".actions.githubusercontent.com"))
      fail("unsupported_context");
    if (!runtime.oidcToken) fail("oidc_unavailable");
    mask2(runtime.oidcToken);
    oidcURL.searchParams.set("audience", config.audience);
    const oidcResponse = await request(oidcURL, {
      headers: {
        Authorization: `Bearer ${runtime.oidcToken}`,
    ...
    const issued = await request(
      `${config.origin}/v1/auth/github-actions/grants`,
      {
        ...
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          "Idempotency-Key": (0, import_node_crypto3.randomUUID)()
        },
        body: JSON.stringify({ assertion: oidc.value })
      }
    );
    if (issued.status !== 201)
      fail(issued.status === 409 ? "credential_unrecoverable" : "grant_denied");
    grant = await json(issued);
    if (typeof grant?.accessToken === "string") mask2(grant.accessToken);
    exactKeys(grant, [
      "grantId",
      "principalType",
      "accessToken",
    ...
    const client = runtime.createClient({
      ...
      fetch: async (req) => {
        ...
        if (url.origin !== config.origin || req.headers.has("cookie") || req.headers.has("origin"))
          fail("credential_destination");
        const response = await request(
          req.url,
          {
            method: req.method,
            headers: req.headers,
            body: ["GET", "HEAD"].includes(req.method) ? void 0 : await req.text()
          },
          true
        );
        if (response.ok) await json(response.clone());
        return response;
      }
    });
    const call = async (method, path, params, body, expectedStatus) => {
      const key = (0, import_node_crypto3.randomUUID)();
    ...
    const upload = await call(
      ...
      project,
      { fileName, sizeBytes: jar.bytes.length, sha256: jar.digest },
      201
    );
    exactKeys(
      upload,
      ["artifactId", "uploadUrl", "expiresAt"],
      ["requiredHeaders"]
    );
    if (!uuid(upload.artifactId)) fail("invalid_response");
    artifactId = upload.artifactId;
    const uploadURL = https(upload.uploadUrl);
    mask2(upload.uploadUrl);
    ...
    for (; ; ) {
      ...
      if (artifact.id !== artifactId || artifact.projectId !== config.project || artifact.sha256 !== jar.digest || artifact.sizeBytes !== jar.bytes.length)
        fail("identity_mismatch");
    ...
    const verifyCandidate = (v) => {
      ...
      if (!uuid(v.id) || candidateId && v.id !== candidateId || v.projectId !== config.project || v.artifactId !== artifactId || v.configurationHash !== configurationHash || v.version !== config.version || !states.has(v.state))
        fail("identity_mismatch");
    };
    ...
    if (!config.wait) outcome = "submitted";
      ...
      for (; ; ) {
        verifyCandidate(candidate);
        if (["failed", "canceled", "published"].includes(candidate.state)) {
        ...
        for (let pageNo = 0; ; pageNo++) {
          ...
          if (!Array.isArray(page.items) || page.items.length > 100 || !object(page.page) || typeof page.page.hasMore !== "boolean")
            fail("invalid_response");
          for (const event of page.items) {
            ...
            if (!object(event) || !uuid(event.id) || event.candidateId !== candidateId || !Number.isSafeInteger(event.sequence) || event.sequence < 0 || !eventKinds.has(event.kind))
              fail("invalid_response");
            ...
            if (seen.has(event.id)) {
              if (seen.get(event.id) !== identity) fail("invalid_response");
              continue;
            }
            if (event.sequence <= sequence || seen.size >= 100 * config.maxPages)
              fail("observation_limit");
            seen.set(event.id, identity);
            sequence = event.sequence;
          }
          if (page.page.nextCursor != null) {
            if (typeof page.page.nextCursor !== "string" || !page.page.nextCursor || page.page.nextCursor.length > 2048 || cursors.has(page.page.nextCursor))
              fail("invalid_response");
    ...
    outcome = "incomplete";
    if (config?.report === "status" && operationDeadline && Date.now() < operationDeadline && !signal.aborted) {
      try {
        await report("incomplete");
      } catch {
...
// src/entry.mjs
var escape2 = (s) => String(s).replaceAll("%", "%25").replaceAll("\r", "%0D").replaceAll("\n", "%0A");
var mask = (s) => process.stdout.write(`::add-mask::${escape2(s)}
`);
var input = (name) => process.env[`INPUT_${name.replaceAll(" ", "_").toUpperCase()}`] || "";
var integer = (name, fallback) => /^\d+$/.test(input(name) || fallback) ? Number(input(name) || fallback) : NaN;
var abort = new AbortController();
process.once("SIGINT", () => abort.abort());
process.once("SIGTERM", () => abort.abort());
function execute(config, runtime) {
...
async function main() {
  ...
  if (env.GITHUB_ACTIONS !== "true" || env.GITHUB_SERVER_URL !== "https://github.com" || !["push", "workflow_dispatch"].includes(env.GITHUB_EVENT_NAME) || input("repository") !== env.GITHUB_REPOSITORY || input("source-commit") !== env.GITHUB_SHA || input("source-ref") !== env.GITHUB_REF || !["true", "false"].includes(input("wait")))
  ...
  for (const [key, value] of Object.entries(result)) {
    if (env.GITHUB_OUTPUT)
      await (0, import_promises3.appendFile)(env.GITHUB_OUTPUT, `${key}=${value}
`);
  }
